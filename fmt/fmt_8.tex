...
\begin{tikzpicture}[scale=1]
    ...
    \path[draw, fill=black] (n0) circle (0.05);
    \path[draw, fill=black] (n1) circle (0.05);
    \path[draw, fill=black] (n2) circle (0.05);
    \path[draw, fill=white] (n3) circle (0.05);
    \path[draw, fill=black] (n4) circle (0.05);
    \path[draw, fill=gray] (n5) circle (0.05);
    \path[draw, fill=black] (n6) circle (0.05);
    \path[draw, fill=black] (n7) circle (0.05);
    \path[draw, fill=black] (n8) circle (0.05);
    \path[draw, fill=black] (n9) circle (0.05);
    \path[draw, fill=gray] (n10) circle (0.05);
