...
\begin{tikzpicture}[scale=1]
    ...
    \path[draw=red!70, fill=white] (n0) circle (0.05);
    \path[draw, fill=white] (n1) circle (0.05);
    \path[draw=red!70, fill=white] (n2) circle (0.05);
    \path[draw, fill=white] (n3) circle (0.05);
    \path[draw=red!70, fill=white] (n4) circle (0.05);
    ...
    \path[draw, fill=gray] (init) circle (0.05) node[below] {$x_\mathrm{init}$};
