...
\begin{tikzpicture}[scale=1]
    ...
    \coordinate (object) at (3.25, 0.75);
    ...
    \draw[thick, red, ->] (virtual) ++ (0.6,-0.75) -- ++(0.3,0);
...
% \def\d1{0.5}
    ...
    \begin{scope} [rotate=0,shift={(camera)}]
        ...
        \draw[fill, blue!60] (3.25,0) circle (0.02);
        \draw[fill, blue!60] (3.25,0.2166) circle (0.02);
        \draw[fill, blue!60] (3.25,0.4333) circle (0.02);
        \draw[fill, blue!60] (3.25,0.65) circle (0.02);
        \draw[fill, blue!60] (3.25,-0.2166) circle (0.02);
        \draw[fill, blue!60] (3.25,-0.4333) circle (0.02);
        \draw[fill, blue!60] (3.25,-0.65) circle (0.02);
